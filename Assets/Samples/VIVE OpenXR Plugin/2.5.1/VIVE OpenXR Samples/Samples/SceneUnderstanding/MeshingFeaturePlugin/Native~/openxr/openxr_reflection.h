...
#define XR_LIST_ENUM_XrLipShapeHTC(_) \
    ...
    _(XR_LIP_SHAPE_MOUTH_RAISER_RIGHT_HTC, 12) \
    _(XR_LIP_SHAPE_MOUTH_RAISER_LEFT_HTC, 13) \
    _(XR_LIP_SHAPE_MOUTH_STRETCHER_RIGHT_HTC, 14) \
    _(XR_LIP_SHAPE_MOUTH_STRETCHER_LEFT_HTC, 15) \
